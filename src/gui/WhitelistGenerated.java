...
public class WhitelistGenerated extends JDialog {
    private JPanel contentPane;
    private JButton buttonOK;

    public WhitelistGenerated() {
    ...
    private void onOK() {
        // add your code here
        WhitelistGenerated.this.dispose();
    }
    ...
    public static void main(String[] args) {
        WhitelistGenerated dialog = new WhitelistGenerated();
        dialog.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("Die Whitelist wurde erfolgreich generiert!");
